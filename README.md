...
После урока вы сможете: **Задеплойте приложение с секретами, health checks и безопасным rollback.**
...
- Артефакт сборки и engines
- Конфигурация окружения и IAM
- Health checks, logs и alarms
- Blue/green, rolling deployment и rollback
...
1. Соберите минимальный пример по теме «7.3. Деплой Node.js: AWS Elastic Beanstalk и общий production checklist».
