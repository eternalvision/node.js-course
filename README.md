...
После урока вы сможете: **Выберите embedding или references осознанно и создайте индексы.**
...
- Embedding против references
- Schema validation и Mongoose
- Индексы, aggregation и транзакции
...
1. Соберите минимальный пример по теме «5.3. MongoDB: документы, схема и моделирование».
