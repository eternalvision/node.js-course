...
После урока вы сможете: **Отправляйте письма вне request path и отслеживайте доставку.**
...
- SMTP и API-провайдеры
- Шаблоны и text fallback
- Очередь, retry и idempotency
- SPF, DKIM, DMARC, bounce и complaint
...
1. Соберите минимальный пример по теме «8. Транзакционная почта: Nodemailer, провайдер и очередь».
